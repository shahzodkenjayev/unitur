...
<tr><td style="font-size:18px" color="#09F">Kategoriya</td></tr>
<?php
...
<tr><td class="headingText">Paketlar</td></tr>
...
<tr><td align="center" style="background-color:#60B0E6; font-size:20px; font-family:Lucida Calligraphy; color:#09F"><a href="detail.php?pid=<?php echo $data[0];   ?>"><font color="#FFFFFF">Ko'proq ma'lumot</font></a></td></tr>
</table>
</td>
<?php
