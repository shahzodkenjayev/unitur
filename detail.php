...
<tr><td class="headingText">Paketlarni ko'rish</td></tr>
...
<tr><td colspan="3"><span class="middletext">Paket nomi:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $data[1];?></td></tr>
...
<tr><td  colspan="3" height="90px"><span class="middletext">Kategoriya:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<?php echo $data[10];?>
 <br/>
  <span class="middletext">Subkategoriya:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <?php echo $data[12];?>
  <br/>
   <span class="middletext">Narx:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <?php echo $data[4];?>
</td></tr>
<tr><td colspan="3"><p><?php echo $data[8];?></p></td></tr>
<tr><td align="left" colspan="3" height="50px"><a href="enquiry.php?pid=<?php echo $data[0];   ?>"><input type="button" value="So'rov" name="sbmt" /></a></td></tr>
</table>
</td>
</tr>
</table>
